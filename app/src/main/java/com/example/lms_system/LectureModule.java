...
public class LectureModule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lecture_module);
        ...
        moduleAdapter = new ModuleAdapter(LectureModule.this,moduleDataArrayList);
        ...
        FloatingActionButton upload = (FloatingActionButton)findViewById(R.id.uploadModule);
    ...
    protected void viewUploadModule(){
        Intent upload = new Intent(this,LectureModuleUpload.class);
